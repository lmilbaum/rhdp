...
// Source https://github.com/Accenture/adop-jenkins/blob/master/resources/init.groovy.d/adop_sonar.groovy

// Check if enabled
def env = System.getenv()
if (!env['RHDP_SONAR_ENABLED'].toBoolean()) {
    println "--> RHDP SonarQube Disabled"
    return
}
